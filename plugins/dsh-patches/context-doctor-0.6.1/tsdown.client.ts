 ...
 * inlined into the bundle. Kept in sync with DSH 0.1.2-rc.1: the module
 * table seeds `@deepseek-ai/dsh-client-store` (the `defineStore` /
 * `EngineStoreHandle` source) and no longer ships the
 * `@deepseek-ai/dsh-client-runtime` package.
 */
