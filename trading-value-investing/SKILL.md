---
name: trading-value-investing
description: 价值投资功法（Mr. Dang）——价值投资完整体系——从顶层设计推导投资逻辑的方法论，涵盖功法体系（天阶/地阶/玄阶/邪修）、投资组合构建、估值方法、仓位控制、有色金属/消费/药品零售等行业分析框架。当用户询问投资逻辑、选股方法、估值分析、仓位管理、行业分析时使用此skill。
---

# 价值投资功法 - Mr. Dang

> 注：chapters/ch01–ch14 均为精简版，完整书籍原文待补（MEMORY 待办）。
...
- 速查表/选股检查清单 → `cheatsheet.md`
- 术语定义 → `glossary.md`
- 投资模式与反模式 → `patterns.md`
