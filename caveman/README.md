...
| `ultra` | Bare fragments, each fact stated once. No invented abbreviations, no arrows. |
...
- [Caveman README](https://github.com/JuliusBrussee/caveman#readme) — repo overview, install, benchmarks
